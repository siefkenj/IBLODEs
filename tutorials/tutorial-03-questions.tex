...
\begin{enumerate}
	...
	$K'(t)=\ldots$ and $L'(t)=\ldots$ with initial conditions $K(0)=0$ and $L(0)=0$.
	...
	\begin{enumerate}
		...
		\item You are given additional information: the solution curve traces out the right loop 
		twice as fast as it traces out the left loop.
