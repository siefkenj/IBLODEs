...
\begin{slide}
	...
	\begin{itemize}
		\item[(P1$_x$ new)] Ignoring all else, the number of parasites decays in proportion to its population with constant $1+a$.
		\item[(P1$_y$ new)] Ignoring all else, hosts numbers grow in proportion to their current number with constant $1-a$.
	\end{itemize}
