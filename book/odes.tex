...
\begin{slide}
	...
	\begin{parts}
		\item Make a \emph{phase portrait} of Fox vs.~Rabbit population. 
		\item Should your phase portrait show a closed curve or a spiral?
		\item What ``direction'' do points move along the curve as time increases? Justify by referring to the model.
		\item What is easier to see from a phase portrait than from component graphs (the graphs of
...
\begin{slide}
	...
	\begin{parts}
		\item By changing initial conditions, what is the ``smallest'' curve you can get in the phase portrait? What happens at
		...
		\item What do the equilibrium solutions look like in the phase portrait? What about their component graphs?
	\end{parts}
\end{slide}
...
\begin{slide}
	...
	\[
		P'(t) = k\cdot P(t)\cdot (R-R_i\cdot P(t))
	\]
	where 
	\begin{itemize}
	...
	\begin{parts}
		...
		\item What does a phase portrait for model \textbf{O} look like? What do graphs of equilibrium solutions look like?
