...
\begin{slide}
	...
	\begin{definition}[Component Graph \& Phase Plane]
		...
		the \emph{component graphs} are the $n$ graphs of $(t, F_1)$, $(t, F_n)$, \ldots.
...
\begin{slide}
	...
	\begin{itemize}
		...
		\item $R_i$ is the resources that one starfish consumes
	\end{itemize}
...
\begin{slide}
	...
	A \emph{slope field} is a plot of small segments of would-be tangent lines
	...
	\begin{parts}
		...
		(a segment of) at $(5,3)$? Write an equation for the line.
...
\begin{slide}
	...
	\begin{definition}[Phase Portrait]
		...
		and its length is given by the speed of a solution when passing through $(x,y)$.
	\end{definition}
	...
	\begin{parts}
		...
		\item Why is the vectors at $(30,300)$ longer than the vector at $(5,50)$? Justify numerically.
	\end{parts}
\end{slide}
...
\begin{slide}
	...
	Use the phase portrait plotter

	\url{https://www.desmos.com/calculator/vrk0q4espx}

	to create a system of differential equations where:

	\begin{parts}
		\item There is an attracting equilibrium solution.
		\item There is a repelling equilibrium solution.
		\item There are no equilibrium solutions.
	\end{parts}
\end{slide}
...
\begin{slide}
	...
	\begin{itemize}
		...
		\item $A(t)\ =$ combined surface area (in square meters) of all leaves at time $t$
	\end{itemize}
	\begin{align*}
...
\begin{slide}
	...
	\begin{parts}
		...
		\item Simulations show solutions with negative values for $H$ and $A$. What actually happens to the tree when this occurs?
	\end{parts}
\end{slide}
