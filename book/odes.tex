...
\begin{slide}
	...
	\begin{itemize}
		...
		\item[(P1$_x$)] Ignoring all else, social media users increase/decrease in proportion to the number of posts.
		\item[(P2$_y$)] Ignoring all else (independent of decay), posts grow by a constant amount of 2 million posts every year.
