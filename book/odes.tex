...
\begin{slide}
	...
	\begin{parts}
		...
		Let $A_{1/2}(t)$ be an \emph{affine} approximation to $\d P/\d t$ that is a good approximation when $P\approx 1/2$.
		Find a formula for $A_{1/2}(t)$.
...
\begin{slide}
	...
	\begin{parts}
		\item What are the similarities/differences in the Desmos pots of solutions
