...
\begin{slide}
	...
	\begin{definition}[Phase Plane]
		...
		the \emph{phase plane} or \emph{phase space} is the $n$-dimensional space with axes corresponding to
...
% XXX Some stuff to figure out about vocab: phase portrait's multiple uses?
