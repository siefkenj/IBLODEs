...
\begin{parts}
	\item If $L=3$m, and you set the pendulum in motion at $\theta =0$ by giving it a small push,
	what does the motion look like?

	\item If $L=3$m, and you set the pendulum in motion at $\theta =0$ by giving it a BIG push,
	what does the motion look like?

	\item Why are there infinitely many equilibrium solutions?
