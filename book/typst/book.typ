...
#serif[
  ...
  #context {
    ...
    for (i, item_heading) in module_headings.enumerate() {
      ...
      let module_label = box(inset: (left: 1.5em), width: 1.5cm, align(center, text([#module_number], size: 1em)))
      let entry = if item_heading.level == 1 {
        ...
        v(-.3em)
        stack(dir: ltr, h(4em + 1em * item_heading.level), text(size: 0.8em, box(item_heading.body)), h(1fr), text(
          size: 0.8em,
          nr,
        ))
      }
...
#serif[
  ...
  // Module 3
  #(env.module)(title: [Systems and Models with Interacting Terms], [
  ...
  // Module 4
  #(env.module)(title: [Equilibrium and Long-Term Behaviour], [
  ...
  // Module 5
  #(env.module)(title: [Qualitative Analysis: Slope Fields and Phase Portraits], [
  ...
  // Module 6
  #(env.module)(title: [Linear Systems with Constant Coefficients (Real Solutions)], [
  ...
  // Module 7
  #(env.module)(title: [Linear Systems with Constant Coefficients (Affine Solutions)], [
  ...
  // Module 8
  #(env.module)(title: [Linear Systems with Constant Coefficients (Complex Solutions)], [
  ...
  // Module 9
  #(env.module)(title: [Quantitative Analysis: Linearization], [
  ...
  // Module 10
  #(env.module)(title: [Higher Order Differential Equations], [
  ...
  // Module 11
  #(env.module)(title: [Introduction to Boundary Value Problems], [
  ...
  // Module 12
  #(env.module)(title: [Introduction to the Theory of Ordinary Differential Equations], [
  ...
  // Appendix A
  #(env.appendix)(title: [Spreadsheets and Programming], [
  ...
  // Appendix B
  #(env.appendix)(title: [Separable Equations], [
  ...
  // Appendix C
  #(env.appendix)(title: [Integrating Factors], [
  ...
  // Appendix D
  #(env.appendix)(title: [Series Solutions], [
  ...
  // Appendix E
  #(env.appendix)(title: [Reduction of Order], [
  ...
  // Appendix F
  #(env.appendix)(title: [Linear Algebra], [
  ...
  // Appendix G
  #(env.appendix)(title: [Complex Numbers], [
