...
#let questions = (
  ...
  (
    ...
    solution: [
      (a) $(dif x)/(dif t) = k x (M - x) + A$, where $A$ is a parameter. (c) The new limiting
  ...
  */
  (
    statement: [
      ...
      + Use Euler's method to find the $lim_(t-> infinity)x(t)$ with the initial condition $x(0)=1$.
        What does this say about the stability of the equilibrium point?
