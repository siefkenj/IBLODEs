...
%Before we tackle the Fourier series, we we study the

Let us take a short glimpse at so-called 
...
What is going on?  
%We will be interested in finding which
...
When dealing with boundary value problems it is very difficult to know whether there exist solutions, or whether they are unique or not.
